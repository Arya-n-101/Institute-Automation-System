...
export default function AssignmentLanding() {
  ...
  useEffect(() => {
    ...
    const fetchCourses = async () => {
      try {
        const response = await fetch(`http://localhost:8000/api/${role}/${userId}/courses`);
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.map((course) => {
          ...
          const courseAssignments = course.numberOfAssignments;
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2 text-gray-700 mb-4">
                ...
                <span className="font-medium">{courseAssignments} Assignments</span>
              </div>
